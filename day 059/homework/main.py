...
# 1) https://www.codewars.com/kata/5a023c426975981341000014/train/python
...
# 3) https://www.codewars.com/kata/58dbdccee5ee8fa2f9000058/train/python

def pythagorean_triple(integers):
    a, b, c = sorted(integers)
    return a ** 2 + b ** 2 == c ** 2

# 4) https://www.codewars.com/kata/5866fc43395d9138a7000006/train/python

def ensure_question(s):
    if s.endswith("?"): # endswith ამოწმებს კონკრეტულ სტრინგში არის თუ არა გადაცემული ასო ან სიმბოლო
        return s
    else:
        return s + "?"
...
# 6) https://www.codewars.com/kata/5808e2006b65bff35500008f/train/python
