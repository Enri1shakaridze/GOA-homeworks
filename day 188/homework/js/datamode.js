let clickk = document.querySelectorAll('.clickk')
let userinform = document.querySelector('.userinform')
...
clickk.forEach(btn => {
    btn.addEventListener('click', function () {
        clickk.forEach(btn2 => {
            btn2.id = 'falsebg'
            if (btn2.dataset.mode === btn.dataset.mode) {
                btn.id = 'truebg'
            }
            if (btn.dataset.mode === 'Watchlist') {
                userinform.style.display = 'none'
            ...
            if (btn.dataset.mode === 'profileowerview') {
                userinform.style.display = 'flex'
                userwatchlist.style.display = 'none'
            }
            if(btn.dataset.mode === 'changepassowrd'){
                userwatchlist.style.display = 'none'
                userinform.style.display = 'none'
